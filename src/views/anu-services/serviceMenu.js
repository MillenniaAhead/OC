        ...
        <form className="contanier ">
          ...
          <div className="d-flex flex-row-reverse bd-highlight me-4"><button type="button" className="btn btn-outline-secondary  dropdown-toggle ms-2">Options </button>
            <UncontrolledDropdown>
              ...
              <DropdownMenu>
                <DropdownItem>New Service </DropdownItem>
                <DropdownItem>New Category </DropdownItem>
              </DropdownMenu>
            </UncontrolledDropdown>
          </div>
          ...
          <div className="d-flex justify-content-start mt-2"><Menu /><h4 className="ms-1">Hair</h4></div>
          <div >
          ...
          <div className="d-flex justify-content-start mt-2"><Menu /><h3 className="ms-1">Face</h3></div>
