      ...
      <div className="side-menu-wrapper-aaa4">
        ...
        <div id='payment-summary-container' className='w-100'>
            <div>
                ...
                <span className='text-bbb3'>Sales by type</span>
                <div className='text-ccc3'>Sales by type</div>
                </div>
                <div>
            ...
            <div className='table-first-column-aaa4'>
                    <div>Type</div>
                    <div>Total</div>
                    <div className='text-aa17'>Service</div>
                    <div>Shipping</div>
                    <div>Memberships</div>
                    <div>No show fees</div>
                    <div>Late cancellation fees</div>
                    <div className='text=aaa17'>Products</div>
                </div>
            <div className="payment-summary-body-container">
                <table className='w-100 table-aaa4'>
                    <thead className='thead-aaa4 thead-aaa17'>
                ...
                <div className='d-flex justify-content-center text-ddd3 mt-1'>Showing 6 of 6 results</div>
        </div>
        </div>
    )
}
