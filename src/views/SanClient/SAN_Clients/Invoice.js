...
const Invoice = () => {
    return (
            ...
            <div style={{width: '150px', height:'48px'}} className=' me-3 bg-white d-flex justify-content-around align-items-center border-0 rounded-pill'>
                                <h6 className='fs-5 mt-1'>Filters</h6>
                                <div> <img  src={filter} alt="" />
</div>
                                   </div>
             </div>
