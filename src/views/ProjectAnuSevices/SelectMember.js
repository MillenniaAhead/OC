...
<span class="input-group-text row justify-content-start w-75 h-50 ">0 Services</span>   
</div></p>
</div>
<div class="row">
<div class="col-6">
...
<input type="text" class="form-control" id="inlineFormInputGroup" placeholder=" " rows=" " />
</div>
</div>
</div>
</div>
...
<div class="mb-3 border-top">
<span class="form-group d-flex flex-row">
<label for="formGroupExampleInput"><h5><b>Tax rate</b></h5></label></span>
</div>
<div class="row">
<div class="col-6">
<div class="form-group form-group d-flex flex-row">
...
<h6 class="row justify-content-start m-1">Choose if you would like to sell your membership online.</h6>
<div class="mb-3 border-top">
