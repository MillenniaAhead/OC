      ...
      <SideMenu link1='/san-reports/dashboard' link2='/san-reports/reports' />
        <div id='payment-summary-container' className=''>
            <div>
                ...
                <span className='text-bbb3'>Tips by team member</span>
                <div className='text-ccc3'>Tips by team member</div>
                </div>
                <div>
...
export default TipsByTeamMember
