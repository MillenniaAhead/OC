      ...
      <SideMenu link1='/san-reports/dashboard' link2='/san-reports/reports' />
        <div id='payment-summary-container' className='w-100'>
            <div>
                ...
                <span className='text-bbb3'>Product sales performance</span>
                <div className='text-ccc3'>Product sales performance</div>
                </div>
                <div>
            ...
            <div className="payment-summary-body-container">
                <table className='w-100 table-aaa4'>
                    <thead className='thead-aaa4 thead-aaa12'>
                        <tr className='tr-aaa4'>
                            <th>Stock on hand</th>
                            <th>Qty Sold Payments</th>
...
export default ProductSalePerformance