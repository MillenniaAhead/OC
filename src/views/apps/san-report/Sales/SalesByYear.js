...
const SalesByYear = () => {
 ...
 <div className="side-menu-wrapper-aaa3">
      ...
      <div className="side-menu-wrapper-aaa4">
        <NavLink to='/san-reports/reports'><ArrowLeft/></NavLink>
      </div>        <div id='payment-summary-container' className='w-100'>
            <div>
                <div className='top-box-xxx2'>
                    <div>
                <span className='text-aaa3 pe-1'>Reports</span>
                <span className='text-bbb3'>Sales by year</span>
                <div className='text-ccc3'>Sales by year</div>
                </div>
                <div>
            ...
            <div className="payment-summary-body-container">
                ...
                <div className='d-flex justify-content-center text-ddd3 mt-1'>Showing 8 of 8 results</div>
        </div>
        </div>
    )
}
