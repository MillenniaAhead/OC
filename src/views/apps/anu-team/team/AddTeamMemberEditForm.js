...
const AddTeamMemberEditForm = () => {
  ...
  useEffect(() => {
      ...
      .then(res => {
        ...
        setRSelected1(myCommission.service_commission_type)
        setRSelected2(myCommission.product_commission_type)
        setRSelected3(myCommission.voucher_commission_type)
        setRSelected4(myCommission.membership_commission_type)
        ...
        setFormData({profile_image:res.data.profile_image, first_name:res.data.first_name, last_name:res.data.last_name, team_member_title:res.data.team_member_title, notes:res.data.notes, email:res.data.email, number:res.data.number ? res.data.number : "", color:res.data.color, team_member_permission:res.data.team_member_permission, location:res.data.location})
      })
